...
silent only
cd ~/orgs/Kosandr/utiltools/src/dbutils
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +105 UserPermissions.py
badd +72 secpassdb.py
badd +1 sdfsd
badd +7 README.md
badd +0 sqlite_wrapper.py
argglobal
silent! argdel *
edit secpassdb.py
...
exe 'vert 1resize ' . ((&columns * 22 + 59) / 119)
exe 'vert 2resize ' . ((&columns * 47 + 59) / 119)
exe 'vert 3resize ' . ((&columns * 48 + 59) / 119)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
205
normal! zo
let s:l = 92 - ((0 * winheight(0) + 32) / 65)
...
93
normal! zo
let s:l = 93 - ((0 * winheight(0) + 32) / 65)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
93
